  ...
  return (
    <>
      ...
      <Content id="CGU">
        ...
        <p>
          <strong>Propriétaire</strong> : Théo B - Shemay B - Benoît M – 2 Allée
          Louis de Broglie 74940 Annecy
          <br />
          <strong>Responsable publication</strong> : Théo B - Sheyma B - Benoît
          M – bruelt@iut-acy.univ-smb.fr
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Théo B - Sheyma B - Benoît M –
          bruelt@iut-acy.univ-smb.fr
          <br />
          <strong>Hébergeur</strong> : Google – - - - -<br />
          <strong>Délégué à la protection des données</strong> : - –
          pasdadresse@gmail.com
          <br />
        </p>
        ...
        Théo B - Shemay B - Benoît M – DPO, - <br />2 Allée Louis de Broglie
        74940 Annecy.
        <p>
        ...
        <div ng-bind-html="rgpdHTML">
          ...
          <p>
            ...
            une période maximale de 9 mois après la fin de la relation
            contractuelle:
            <br />
          ...
          <p>
            {" "}
            Ces &nbsp;données sont conservées pour une période maximale de 9
